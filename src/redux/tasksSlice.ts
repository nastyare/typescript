...
const tasksSlice = createSlice({
  ...
  reducers: {
    ...
    reorderTask: (state, action: PayloadAction<{ sourceIndex: number; destinationIndex: number }>) => {
    ...
    copyTask: (_, action: PayloadAction<{ title: string; fullDescription: string }>) => {
...
export const { addTask, editTask, deleteTask, reorderTask, copyTask } = tasksSlice.actions
